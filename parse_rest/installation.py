...
class Installation(ParseResource):
    ...
    def update_channels(cls, channels_to_add=set(),
        ...
        """
        new_channels = list(set(cls.channels).union(channels_to_add).difference(channels_to_remove))
        cls.PUT(cls._absolute_url, channels=new_channels)
